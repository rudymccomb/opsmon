...
2. [Setup - The basics of getting started with opsmon](#setup)
    * [What opsmon affects](#what-opsmon-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with opsmon](#beginning-with-opsmon)
